...
public class CircleBreakerController {
    ...
    @SentinelResource(value = "fallback", fallback = "handlerFallback",blockHandler = "blockHandler", //优先走sentinel配置异常
            exceptionsToIgnore = {IllegalArgumentException.class}) //忽略异常，直接打到page
